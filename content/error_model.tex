...
\begin{figure}
  \centering
  \includegraphics[width = 0.9\textwidth, height = 0.6\textheight]{false_cut_error_loc}
\end{figure}
\begin{gather*}
...
\begin{figure}
  \centering
  \includegraphics[width = 0.9\textwidth, height = 0.6\textheight]{false_cut_error}
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width = 0.9\textwidth]{false_cut_solution}
\end{figure}
\end{frame}
